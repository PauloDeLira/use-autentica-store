  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.filters}>
        <select value={categoryId} onChange={(event) => updateFilter("categoriaId", event.target.value)}>
        ...
        <select value={sizeId} onChange={(event) => updateFilter("tamanhoId", event.target.value)}>
        ...
        <select value={colorId} onChange={(event) => updateFilter("corId", event.target.value)}>
