...
import { registerWhatsAppClick } from "../../api/products";
...
export function PurchaseWhatsApp({ productId, productName, price, variant }: PurchaseWhatsAppProps) {
  ...
  function handleClick() {
    // Fire-and-forget: mede intencao de compra, mas nunca atrasa nem
    // impede a abertura do WhatsApp, mesmo se a chamada falhar.
